<?php
  ...
  $PHORUM['ForumName']='Development';
  $PHORUM['ForumDescription']='Discussion about FreshPorts Development';
  ...
  $PHORUM['ForumTableName']='development';
  $PHORUM['ForumModeration']='r';
  $PHORUM['ForumSecurity']='1';
  $PHORUM['ForumEmailList']='dan@langille.org';
  $PHORUM['ForumEmailReturnList']='phorum@develop.freshports.org';
